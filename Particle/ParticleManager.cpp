...
void ParticleManager::LevelUpParticle(int PartNum, XMFLOAT3 Position, XMFLOAT3 EndPosition, float Vel, int ParticleLife, float StartScale, float EndScale, XMFLOAT4 start_color, XMFLOAT4 end_color)
{
	for (int i = 0; i < PartNum; i++)
	{
		//中心座標
